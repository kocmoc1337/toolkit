...
{C}     ░         ░  ░          ░           ░  ░      ░       ░        ░ ░        ░  {E}
{C}                                               ░       ░                           {E}
{G}v1.1 | Developer: verifactor @newince
{E}
""")
...
def menu():
    ...
    print(f"""
{C}┌─────────────────────────────────────────────────────┐
{C}│{W}                  ULTRA DDOS v1.1                   {C}│
{C}├─────────────────────────────────────────────────────┤
{C}│                                                     │
{C}│  {W}1.  {C}HTTP Load Test                             │
{C}│  {W}99. {C}Exit                                      │
{C}│                                                     │
{C}└─────────────────────────────────────────────────────┘
{E}
...
def main():
    while True:
        menu()
        ch = input(f"{C}┌─ {W}Выбери{C} ──────────────────────────────────┐\n{C}│{W} > {C}")
        if ch == '1':
            run_test()
        elif ch == '99':
            clear()
            print(f"{C}╔═══════════════════════════════════════════════╗")
            print(f"{C}║{W}         ЗАВЕРШЕНИЕ РАБОТЫ              {C}║")
            print(f"{C}╚═══════════════════════════════════════════════╝{E}")
            sys.exit()
        else:
